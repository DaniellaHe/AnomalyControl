...
from ano_csm.models.blip2_models.blip2 import Blip2Base, disabled_train, LayerNorm
from ano_csm.models.ulip_models.ULIP_models import ULIP_PointBERT
from ano_csm.tasks.multimodal_classification import MultimodalClassificationTask
...
from ano_csm.processors.blip_processors import BlipCaptionProcessor
...
class Blip2VicunaXInstruct(Blip2Base):
    ...
    def __init__(
        ...
        from ano_csm.models.blip2_models.modeling_llama import LlamaForCausalLM
    ...
    def init_audio_encoder(
        ...
        if "beats" in model_name:
            from ano_csm.models.beats_encoder import BeatsEncoder
