...
from ano_csm.common.utils import get_abs_path
from ano_csm.models.base_model import BaseModel
from ano_csm.models.clip_models.clip_outputs import ClipOutput, ClipOutputFeatures
from ano_csm.models.clip_models.timm_model import TimmModel
from ano_csm.models.clip_models.transform import image_transform
from ano_csm.models.clip_models.utils import freeze_batch_norm_2d
...
class CLIP(BaseModel):
    ...
    def loss(self):
        if self._loss is None:
            from ano_csm.models.clip_models.loss import ClipLoss
    ...
    def zero_shot_predict(self, image_path, categories):
        ...
        from ano_csm.processors.clip_processors import ClipImageEvalProcessor
