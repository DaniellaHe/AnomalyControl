...
def main():
    ...
    with torch.no_grad():
        sg_tokens = image_proj_model(image_embeds)
    print("ip_tokens shape:", sg_tokens.shape)
    assert sg_tokens.shape == (BATCH_SIZE, NUM_QUERIES + NUM_LATENTS_MEAN_POOLED, OUTPUT_DIM)
