...
from ano_csm.models.ulip_models import losses
...
def ULIP_PointBERT(ulip_v=2):
    ...
    from ano_csm.models.ulip_models.pointbert.point_encoder import PointTransformer
    from ano_csm.models.ulip_models.utils.config import cfg_from_yaml_file
    ## TODO: parse as config
    # config_addr = '/export/home/LAVIS/ano_csm/models/ulip_models/pointbert/PointTransformer_8192point.yaml'
